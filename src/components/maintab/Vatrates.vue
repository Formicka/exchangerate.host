  ...
  >
    <div class="row">
      <div class="col-lg-4 mt-45">
        ...
        <p class="text">
          Our accurate EU VAT information API simplifies in and around the
          European Union. Request a single by country code or entire set EU VAT
          rates.
        </p>
        ...
        <ParametersInfo
          ...
          v-bind:amount="false"
          v-bind:places="false"
          v-bind:symbolsCustom="'symbols=FI,IT'"
        ></ParametersInfo>
      </div>
      <div class="col-lg-8">
